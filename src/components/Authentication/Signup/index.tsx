        ...
        <KeyboardAwareScrollView style={{ backgroundColor: "black", height: hp("100%") }}>
            <View style={{ marginHorizontal: 15 }}>
                <View style={style.helloView}>
                    <Text style={{ fontSize: 48, color: "#1877F2", fontWeight: "600" }}>Hello!</Text>
                </View>
                        ...
                        <View style={{ marginHorizontal: 15 }}>
                            ...
                            <TouchableWithoutFeedback onPress={handleSubmit}>
                                <View style={style.loginBtn}>
                                    <Text style={[commonStyles.textColor, { fontSize: 18 }]}>Signup</Text>
                                </View>
            ...
            <View style={[commonStyles.flex, { alignItems: "center", justifyContent: "center", marginVertical: 15 }]}>
                <Text style={[commonStyles.textColor, { fontWeight: "500" }]}>Already have an account? </Text>
