    ...
    return (
        <KeyboardAwareScrollView style={{ backgroundColor: "black", height: hp("100%") }}>
            <View style={{ display: "flex", flexDirection: "row", alignItems: "center", marginVertical: 10 }}>
                ...
                <Text style={{ color: "white", marginLeft: 100, fontWeight: "600", fontSize: 16 }}>Select your country</Text>
            </View>
            <View style={{ display: "flex", justifyContent: "space-between", flexDirection: "column" }}>
                <View style={{ marginTop: 40, marginHorizontal: 10 }}>
                    ...
                    <Icon name="caret-down-outline" size={35} color="white" style={{ position: "absolute", right: 10, top: 12 }} onPress={() => setVisible(true)} />
                    <CountryPicker
                        {...{
                            withCallingCode,
                            withAlphaFilter,
                ...
                <TouchableOpacity style={{ backgroundColor: "blue", paddingVertical: 15, alignItems: "center", marginHorizontal: 10, borderRadius: 8, marginTop: hp("68%") }} onPress={nextPress}>
